...
export class ImperviousUpdateFormComponent implements OnInit {
  @Input() impervious: Impervious | null = null;
  ...
  ngOnInit() {
    if (this.impervious) {
      this.form
        .get("BuildingImpervious")
        ?.setValue(this.impervious.BuildingImpervious);
      this.form
        .get("ParkingImpervious")
        ?.setValue(this.impervious.ParkingImpervious);
      this.form
        .get("RoadTrailImpervious")
        ?.setValue(this.impervious.RoadTrailImpervious);
      this.form
        .get("RecreationImpervious")
        ?.setValue(this.impervious.RecreationImpervious);
      this.form.get("MiscImpervious")?.setValue(this.impervious.MiscImpervious);
      this.form
        .get("OtherImpervious")
        ?.setValue(this.impervious.OtherImpervious);
      this.form
        .get("PermittedImpervious")
        ?.setValue(this.impervious.PermittedImpervious);
    }
  }
  onSubmit() {
    if (this.impervious) {
      this.impervious.BuildingImpervious =
        this.form.get("BuildingImpervious")?.value;
      this.impervious.ParkingImpervious =
        this.form.get("ParkingImpervious")?.value;
      this.impervious.RoadTrailImpervious = this.form.get(
        "RoadTrailImpervious",
      )?.value;
      this.impervious.RecreationImpervious = this.form.get(
      ...
      this.impervious.PermittedImpervious = this.form.get(
        "PermittedImpervious",
      )?.value;
